...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Amberhost web application."
  #
  #
  ...
  #
  # settings.secret_key_base= XJMGkzJMnwG-IWRKqYHaKkaCe_Z9NW41kHyFGGE3Dx8
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("amberhost.log", "w"))
  #
  #
end
